...
class Dashboard extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('Kader3/index', $data);
	...
	public function data_kesehatan_lansia()
	{
		$data['title'] = 'Data Lansia';
		$this->load->view('Template/Kader3/header_kader', $data);
		$this->load->view('Kader3/data_kesehatan_lansia', $data);
		$this->load->view('Template/Kader3/footer_kader', $data);
	}
	public function data_kegiatan()
	{
		$data['title'] = 'Data Lansia';
		$this->load->view('Template/Kader3/header_kader', $data);
		$this->load->view('Kader3/data_kegiatan', $data);
		$this->load->view('Template/Kader3/footer_kader', $data);
	}
	public function keterangan_kegiatan()
	{
		$data['title'] = 'Data Lansia';
		$this->load->view('Template/Kader3/header_kader', $data);
		$this->load->view('Kader3/keterangan_kegiatan', $data);
		$this->load->view('Template/Kader3/footer_kader', $data);
	}
}

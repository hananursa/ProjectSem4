...
class data_lansia extends CI_Controller{
  ...
  public function index(){
    $data['data_lansia'] = $this->Lansia_model->tampil_data_kader();
  ...
  public function tambah_data_lansia(){
    ...
    $this->load->view('Template/Kader/header',$data);
    $this->load->view('Kader/lansia_form',$data);
    $this->load->view('Template/Kader/footer',$data);
  } 
  ...
  public function update($id_lansia){
    ...
    $this->load->view('Template/Kader/header',$data);
    $this->load->view('Kader/lansia_update',$data);
    $this->load->view('Template/Kader/footer',$data);
  }

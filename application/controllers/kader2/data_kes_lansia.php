...
class data_kes_lansia extends CI_Controller{
  ...
  public function index(){
    ...
    $this->load->view('kader2/data_kes_lansia', $data);
  ...
  public function tambah_data_kes_lansia(){
    ...
    $this->load->view('Template/Kader2/header_kader',$data);
    $this->load->view('kader2/kesehatan_form', $data);
    $this->load->view('Template/Kader2/footer_kader',$data);
  ...
  public function tambah_data_kes_lansia_aksi(){
    ...
    if($this->form_validation->run() == FALSE){
      ...
      redirect('kader2/data_kes_lansia');
    }
  }
  public function update($id_kesehatan){
    ...
    $this->load->view('Template/Kader2/header_kader',$data);
    $this->load->view('kader2/kesehatan_update', $data);
    $this->load->view('Template/Kader2/footer_kader',$data);

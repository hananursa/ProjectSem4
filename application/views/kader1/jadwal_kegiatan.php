...
<<<<<<< HEAD:application/views/kader/jadwal_kegiatan.php
		...
		<div class="parallax-overlay">
			<div class="container pageTitle">
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 text-right">
						<span class="page-location">Kader1/Kegiatan</span>
					</div> <!-- /.col-md-6 -->
				</div> <!-- /.row -->
			</div> <!-- /.container -->
		</div> <!-- /.parallax-overlay -->
	</div> <!-- /.pageTitle -->
>>>>>>> 721deb13d41ba81b12692e1b19a352488751b090:application/views/kader1/jadwal_kegiatan.php
...
=======
  <!-- <?= anchor('kader1/jadwal_kegiatan/tambah_jadwal_kegiatan', '<button class="btn btn-primary btn-sm mb-2"><i class="fas fa-plus fa-sm"></i> Tambah Data Jadwal Kegiatan</button>') ?> -->
  ...
  <table class="table table-borderd table-hover table-striped">
    ...
    <tr>
      ...
      <td width="20px"><?= anchor('kader1/jadwal_kegiatan/update/'.$jadwal_kegiatan->id_jadwal, '<div class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></div>') ?></td>
      <td width="20px"><?= anchor('kader1/jadwal_kegiatan/hapus/'.$jadwal_kegiatan->id_jadwal, '<div onclick="return confirm(\'Yakin akan menghapus?\')" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></div>') ?></td>
    </tr>
    <?php endforeach; ?>
  </table>
>>>>>>> 721deb13d41ba81b12692e1b19a352488751b090:application/views/kader1/jadwal_kegiatan.php

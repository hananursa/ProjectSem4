<div class="first-widget parallax" id="portfolio">
  ...
  <table class="table table-borderd table-hover table-striped">
    ...
    <td><?= $data_lansia->id_posyandu; ?></td>
      ...
      <td width="20px"><?= anchor('kader/data_lansia/hapus/'.$data_lansia->id_lansia, '<div onclick="return confirm(\'Yakin akan menghapus?\')" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></div>') ?></td>
    </tr>
    <?php endforeach; ?>
  </table>
  <?= $this->session->flashdata('pesan'); ?>

  <?= anchor('kader/data_lansia/tambah_data_lansia', '<button class="btn btn-primary btn-sm mb-2"><i class="fas fa-plus fa-sm"></i> Tambah Data</button>') ?>
</div>